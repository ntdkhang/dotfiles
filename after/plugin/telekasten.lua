local home = vim.fn.expand("/Users/dk/Documents/Personal/Notes/CS")
...
require('telekasten').setup({
    ...
    vaults = {
        journal = {
            ...
            home = "/Users/dk/Documents/Personal/Notes/journal"
        },
    },
...
vim.keymap.set("n", "<leader>zf", ":lua require('telekasten').search_notes()<CR>")
vim.keymap.set("n", "<leader>zg", ":lua require('telekasten').follow_link()<CR>")
...
vim.keymap.set("n", "<leader>zp", ":lua require('telekasten').paste_img_and_link()<CR>")
...
vim.keymap.set("n", "<leader>zi", ":lua require('telekasten').insert_link({ i=true })<CR>")
vim.keymap.set("n", "<leader>zI", ":lua require('telekasten').insert_img_link()<CR>")
...
vim.keymap.set("n", "<leader>zz", ":lua require('telekasten').panel()<CR>")
